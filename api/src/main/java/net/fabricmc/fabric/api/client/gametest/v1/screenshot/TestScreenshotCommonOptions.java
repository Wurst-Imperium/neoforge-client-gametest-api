...
public interface TestScreenshotCommonOptions<SELF extends TestScreenshotCommonOptions<SELF>>
{
	...
	/**
	 * Changes the delta ticks to take this screenshot with. Delta ticks
	 * controls interpolation between the previous tick and the
	 ...
	 *
	 * @param deltaTicks
	 *            The delta ticks to take this screenshot with
	 * @return This screenshot options instance
	 */
